            ...
            <tbody>
                @foreach($all_category_product as $key => $cate_pro)
                    ...
                    <td>
                        ...
                        <a onclick="return confirm('Bạn có chắc không muốn xóa không?')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="active styling-edit" ui-toggle-class="">
